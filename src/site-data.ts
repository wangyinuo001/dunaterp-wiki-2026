...
export const pages: Record<string, WikiPage> = {
  ...
  engineering: {
    ...
    sections: [
      { eyebrow: "Design rationale", title: "Start at the lycopene branch", body: "Pathway structure places LCYB at the conversion from lycopene to β-carotene. The public light-intensity transcriptome characterises pathway expression; the nine-state model explores how an assumed promoter response could alter β-carotene concentration." },
      { eyebrow: "Computational result", title: "Track the main product", body: "In the current promoter scenarios, regulatory activity and binding affinity change LCYB transcription and the simulated day-7 β-carotene pool. Separate branch-capacity and FBA calculations describe downstream allocation and network limits. These simulations can inform a Design–Build–Test–Learn cycle once biological measurements are available." },
  ...
  experiments: {
    ...
    sections: [
      ...
      { title: "Modelling workflow", body: "The Mathematical Modeling page records the nine-state ODE, literature-constrained fitting, promoter-occupancy scenarios and a separate FBA bound analysis. Parameters, units and figure captions identify measured constraints and model assumptions." },
    ],
  },
  results: {
    ...
    sections: [
      ...
      { title: "β-carotene is a model output", body: "The promoter-occupancy scenarios propagate assumed regulatory changes through LCYB transcript and enzyme abundance to a simulated day-7 β-carotene concentration. The public dataset contains expression measurements, not pigment output from the engineered project strain." },
    ],
  },
  model: modeling,
